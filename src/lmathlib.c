...
//      lua_pushnumber(L, floor(r*u)+1); // removed floor() by rafael2k - 01/03/2025
      lua_pushnumber(L, r % u);  /* int between 1 and `u' */
      break;
    }
...
//      lua_pushnumber(L, floor(r*(u-l+1))+l); // removed floor() by rafael2k - 01/03/2025
      lua_pushnumber(L,  (r % (u - l)) + l);  /* int between `l' and `u' */
      break;
    }
